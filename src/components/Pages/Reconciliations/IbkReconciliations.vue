<template>
    ...
    <TableLite :is-slot-mode="true" :isLoading="tableConfig.isLoading" :title="'IBK Conciliaciones'"
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div class="card p-4 bg-green-200 text-blue-700 shadow-md rounded-lg">
                    <div class="space-y-2">
                        ...
                        <p><strong>Fecha de Correo:</strong> {{ formatDateTime(currentReconciliation.ibk.date_time) }}</p>
                        <p><strong>Numero de Cuenta:</strong> {{ currentReconciliation.ibk.account_destination }}</p>
                    </div>
                </div>
