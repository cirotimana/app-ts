<template>
    ...
    <TableLite :is-slot-mode="true" :isLoading="tableConfig.isLoading" :title="'BCP Conciliaciones'"
    ...
    <!-- Modal -->
    <Modal v-model="isModalVisible" :title="'Detalles'" :size="'lg'">
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div class="card p-4 bg-orange-200 text-blue-900 shadow-md rounded-lg">
                    <div class="space-y-2">
                        ...
                        <p><strong>Fecha de Correo:</strong> {{ formatDateTime(currentReconciliation.bcp.date_time) }}</p>
                        <p><strong>Numero de cuenta:</strong> {{ currentReconciliation.bcp.account_destination }}</p>
                    </div>
                </div>
                ...
                <div class="card p-4 bg-slate-100 shadow-md rounded-lg">
                    <div class="space-y-2">
                        ...
                        <p><strong>Numero de cuenta:</strong> {{ currentReconciliation.at.account_number }}</p>
                    </div>
                </div>
            </div>
        </div>
...
const initialColumns = [
    ...
    { label: "%Similitud", field: "score", sortable: true, width: "5%", columnClasses: ["text-center"] },
    { label: "#Operacion", field: "operation", sortable: true, width: "5%", columnClasses: ["text-center"] },
    { label: "Cliente", field: "beneficiary", sortable: true, width: "25%", columnClasses: ["text-indigo-700"] },
    { label: "Fecha de Correo", field: "date", sortable: true, width: "15%" },
    { label: "Numero de Cuenta", field: "account", sortable: true, width: "15%" },
    { label: "Fecha de Creacion", field: "created", width: "15%", columnClasses: ["text-center"] },
    { label: "Monto", field: "amount", sortable: true, width: "5%", columnClasses: ["text-right"] },
